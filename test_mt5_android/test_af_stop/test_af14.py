    ...
    def test_tc14(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_pending_order(driver=main_driver, order_type=OrderExecutionType.STOP, option=TradeDirectionOption.SELL, tp_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_DAY)
            ...
            with allure.step("Modify Stop Order"):
                modify_pending_order(driver=main_driver, order_type=OrderExecutionType.STOP, tp_type=SLTPOption.PRICE, expiry_type=ExpiryType.SPECIFIED_DATE, expiry_date="19", target_month=parse("April 2025"))
