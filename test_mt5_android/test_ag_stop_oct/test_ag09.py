    ...
    def test_tc09(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_pending_order(driver=main_driver, order_type=OrderExecutionType.STOP, option=TradeDirectionOption.SELL, expiry_type=ExpiryType.GOOD_TILL_CANCELLED)
