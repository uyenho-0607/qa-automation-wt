...
def android_driver(appium_server_url="http://localhost:4723"):
    ...
    # SIT 
    options.app_package = "com.aquariux.wt.sit.transactcloudmt5"
    options.app_activity = "com.aquariux.wt.sit.transactcloudmt5.MainActivity"
    
    # UAT
    # options.app_package = "com.aquariux.wt.uat.transactcloudmt5"
    # options.app_activity = "com.aquariux.wt.uat.transactcloudmt5.MainActivity"
