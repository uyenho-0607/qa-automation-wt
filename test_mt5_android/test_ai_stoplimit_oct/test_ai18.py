    ...
    def test_tc18(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_pending_order(driver=main_driver, order_type=OrderExecutionType.STOP_LIMIT, option=TradeDirectionOption.SELL, expiry_type=ExpiryType.GOOD_TILL_DAY, tp_type=SLTPOption.PRICE)
