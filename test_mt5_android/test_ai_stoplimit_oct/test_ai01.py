    ...
    def test_tc01(self, android_driver):
        ...
        try:
            ...
            with allure.step("Modify StopLimit Order"):
                modify_pending_order(driver=main_driver, order_type=OrderExecutionType.STOP_LIMIT, sl_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_CANCELLED)
