    ...
    def test_tc11(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_pending_order(driver=main_driver, order_type=OrderExecutionType.STOP_LIMIT, option=TradeDirectionOption.SELL, sl_type=SLTPOption.POINTS, expiry_type=ExpiryType.SPECIFIED_DATE, expiry_date="19", target_month=parse("April 2025"))
            ...
            with allure.step("Modify Stop Limit Order"):
                modify_pending_order(driver=main_driver, order_type=OrderExecutionType.STOP_LIMIT, sl_type=SLTPOption.POINTS, expiry_type=ExpiryType.SPECIFIED_DATE, expiry_date="19", target_month=parse("April 2025"))
