    ...
    def test_tc10(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_pending_order(driver=main_driver, order_type=OrderExecutionType.STOP_LIMIT, option=TradeDirectionOption.SELL, expiry_type=ExpiryType.GOOD_TILL_DAY)
            ...
            with allure.step("Modify Stop Limit Order"):
                modify_pending_order(driver=main_driver, order_type=OrderExecutionType.STOP_LIMIT, tp_type=SLTPOption.POINTS, expiry_type=ExpiryType.GOOD_TILL_CANCELLED)
