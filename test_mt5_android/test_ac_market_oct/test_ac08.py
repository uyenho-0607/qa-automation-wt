    ...
    def test_tc08(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.BUY, sl_type=SLTPOption.POINTS, tp_type=SLTPOption.PRICE, trade_constants=TradeConstants.PRE_TRADE)
