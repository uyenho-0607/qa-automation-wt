    ...
    def test_tc13(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_pending_order(driver=main_driver, order_type=OrderExecutionType.LIMIT, option=TradeDirectionOption.SELL, tp_type=SLTPOption.POINTS, expiry_type=ExpiryType.GOOD_TILL_CANCELLED)
            ...
            with allure.step("Modify Limit Order"):
                modify_pending_order(driver=main_driver, order_type=OrderExecutionType.LIMIT, tp_type=SLTPOption.POINTS, expiry_type=ExpiryType.GOOD_TILL_DAY)
