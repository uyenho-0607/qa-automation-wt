    ...
    def test_tc02(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_pending_order(driver=main_driver, order_type=OrderExecutionType.LIMIT, option=TradeDirectionOption.BUY, expiry_type=ExpiryType.GOOD_TILL_DAY)
            ...
            with allure.step("Modify Limit Order"):
                modify_pending_order(driver=main_driver, order_type=OrderExecutionType.LIMIT, tp_type=SLTPOption.POINTS, expiry_type=ExpiryType.SPECIFIED_DATE_AND_TIME, expiry_date="19", target_month=parse("April 2025"), hour_option="11", min_option="35")
