import allure
from enums.main import Server, CredentialType, AlertType
    ...
    def test_tc05(self, androidDriver):
        ...
        try:
            ...
            with allure.step("Login to Web Trader Membersite"):
                login_wt(driver=main_driver, server=Server.MT5, testcase_id="TC02", credential_type=CredentialType.INVALID_CREDENTIAL, expectation=AlertType.FAILURE)
