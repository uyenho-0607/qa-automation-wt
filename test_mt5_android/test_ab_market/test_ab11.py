    ...
    def test_tc11(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.SELL, trade_constants=TradeConstants.SET_FILL_POLICY, sl_type=SLTPOption.POINTS)
