    ...
    def test_tc08(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.BUY, trade_constants=TradeConstants.SET_FILL_POLICY, sl_type=SLTPOption.POINTS, tp_type=SLTPOption.PRICE)
            ...
            with allure.step("Modify on Market Order"):
                modify_market_order(driver=main_driver, sl_type=SLTPOption.PRICE, tp_type=SLTPOption.POINTS)
