...
from common.mobileapp.login.utils import login_wt, menu_button
from common.mobileapp.symbol.utils import input_symbol
from common.mobileapp.trade.utils import toggle_radioButton_OCT, trade_market_order, modify_market_order, trade_ordersConfirmationDetails, get_trade_snackbar_banner, compare_dataframes, process_and_print_data, extract_order_info, process_order_notifications
...
class TC_MT4_aB01():
    ...
    def test_TC01(self, init_driver):
        ...
        try:
            ...
            with allure.step("Modify on Market Order"):
                modify_market_order(driver=main_driver, trade_type="edit", row_numbers=1, sl_type="points", set_takeProfit=False)
