...
from enums.main import Server, TradeDirectionOption, SLTPOption, ButtonModuleType, ExpiryType, OrderPanel, SectionName
...
from common.desktop.module_trade.utils import toggle_radio_button, trade_limit_order, close_delete_order, trade_orders_confirmation_details, get_trade_snackbar_banner, extract_order_info
...
class TC_MT4_aD17():
    ...
    def test_tc17(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, option=TradeDirectionOption.BUY, expiry_type=ExpiryType.GOOD_TILL_DAY, sl_type=SLTPOption.POINTS)
