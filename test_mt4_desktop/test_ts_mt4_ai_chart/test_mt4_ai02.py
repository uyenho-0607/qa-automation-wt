...
from enums.main import Server, ButtonModuleType, TradeDirectionOption, SLTPOption, OrderPanel, SectionName
    ...
    def test_tc02(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.SELL, chart_fullscreen="toggle", sl_type=SLTPOption.PRICE, tp_type=SLTPOption.POINTS)
