    ...
    def test_tc02(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.SELL, set_Chart=True, chart_fullscreen="toggle", sl_type=SLTPOption.PRICE, tp_type=SLTPOption.POINTS)
