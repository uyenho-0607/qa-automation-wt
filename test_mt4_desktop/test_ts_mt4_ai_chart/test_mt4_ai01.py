    ...
    def test_tc01(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.BUY, set_Chart=True, chart_fullscreen="toggle", sl_type=SLTPOption.POINTS, tp_type=SLTPOption.PRICE)
