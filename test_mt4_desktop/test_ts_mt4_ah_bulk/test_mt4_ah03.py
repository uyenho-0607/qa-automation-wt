    ...
    def test_tc03(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Bulk Close Orders"):
                ...
                open_position_df = button_bulk_operation(driver=main_driver, filename="MT4_Bulk.csv", bulk_type="close", section_name="Open Position", tab_order_type="open-positions", set_sorting=True)
