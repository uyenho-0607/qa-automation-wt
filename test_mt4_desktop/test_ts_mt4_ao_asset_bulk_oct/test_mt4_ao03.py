    ...
    def test_tc03(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Bulk Close Orders"):
                ...
                open_position_df = button_bulk_operation(driver=main_driver, filename="MT4_Bulk.csv", bulk_type="close", section_name=SectionName.ASSET_OPEN_POSITION, tab_order_type=OrderPanel.OPEN_POSITIONS, symbol_name_element=True, set_trade=False, set_sorting=True)
