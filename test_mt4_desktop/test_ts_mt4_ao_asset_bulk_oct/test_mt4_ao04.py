    ...
    def test_tc04(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Bulk Delete Orders"):
                ...
                pending_order_df = button_bulk_operation(driver=main_driver, filename="MT4_Bulk.csv", bulk_type="delete", section_name="Pending Order", tab_order_type=OrderPanel.PENDING_ORDERS, symbol_name_element=True, set_trade=False)
