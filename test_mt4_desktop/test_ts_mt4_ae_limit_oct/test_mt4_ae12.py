    ...
    def test_tc12(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, option=TradeDirectionOption.SELL, sl_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_CANCELLED)
            ...
            with allure.step("Modify Limit Order"):
                modify_limit_order(driver=main_driver, sl_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_DAY)
