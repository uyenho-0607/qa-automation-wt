...
from enums.main import Server, TradeDirectionOption, ExpiryType, AlertType
from constants.helper.driver import shutdown
from constants.helper.screenshot import attach_session_video_to_allure, attach_text

from common.desktop.module_login.utils import login_wt
from common.desktop.module_symbol.utils import input_symbol
from common.desktop.module_trade.utils import toggle_radio_button, trade_limit_order, get_neg_snackbar_banner
...
class TC_MT4_aQ07():
    ...
    @allure.title("TC_MT4_aQ07")

    @allure.description(
        """
        (Place) OCT - Pending Order (Limit) Sell Order
    ...
    def test_tc07(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, option=TradeDirectionOption.SELL, expiry_type=ExpiryType.GOOD_TILL_CANCELLED, entry_price_flag=AlertType.NEGATIVE)
