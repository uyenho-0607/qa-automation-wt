...
from common.desktop.module_trade.utils import toggle_radio_button, trade_stop_order, modify_stop_order, get_neg_snackbar_banner, trade_orders_confirmation_details, get_trade_snackbar_banner, extract_order_info
    ...
    def test_tc20(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, option=TradeDirectionOption.SELL, expiry_type=ExpiryType.GOOD_TILL_DAY)
            ...
            with allure.step("Modify on Stop Order"):
                modify_stop_order(driver=main_driver, tp_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_CANCELLED, take_profit_flag=AlertType.NEGATIVE)
