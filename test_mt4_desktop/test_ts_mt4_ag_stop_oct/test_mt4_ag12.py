    ...
    def test_tc12(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, option=TradeDirectionOption.SELL, sl_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_CANCELLED)
            ...
            with allure.step("Modify Stop Order"):
                modify_stop_order(driver=main_driver, sl_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_DAY)
