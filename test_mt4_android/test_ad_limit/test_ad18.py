...
from enums.main import Server, OrderExecutionType, TradeConstants, TradeDirectionOption, SLTPOption, ButtonModuleType, ExpiryType, OrderPanel, SectionName
    ...
    def test_tc18(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_pending_order(driver=main_driver, order_type=OrderExecutionType.LIMIT, option=TradeDirectionOption.SELL, expiry_type=ExpiryType.GOOD_TILL_CANCELLED, tp_type=SLTPOption.POINTS)
