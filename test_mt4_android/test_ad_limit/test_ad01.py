...
@allure.epic("MT4 Android ts_ad - Limit")
        ...
        try:
            ...
            with allure.step("Verify if it is the same order_ids"):
                if original_order_id == updated_order_id:
                    clear_order_ids_csv(filename="MT4_mobileapp_Pending_Order.csv")
                    append_order_ids_to_csv(order_ids=updated_order_id, filename="MT4_mobileapp_Pending_Order.csv")
