...
class TC_MT4_aR06():
    ...
    @allure.description(
        """
        Verify user click on the side menu verification bar is redirected to the correct tab
        """
    )
    
    def tt_tc06(self, android_driver):
        ...
        try:
            ...
            with allure.step("Clear Search History"):
                verify_mesthead_banner(driver=main_driver)
