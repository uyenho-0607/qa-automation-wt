...
from enums.main import Menu, Server, ModuleOCT, OrderExecutionType, TradeDirectionOption, SLTPOption, ExpiryType, OrderPanel, SectionName
    ...
    def test_tc01(self, android_driver):
        ...
        try:
            ...
            #     input_symbol(driver=main_driver, server=Server.MT4)
                menu_button(driver=main_driver, menu=Menu.TRADE)
            ...
            with allure.step("Modify Limit Order"):
                modify_pending_order(driver=main_driver, order_type=OrderExecutionType.LIMIT, sl_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_CANCELLED)
