...
class TC_aC14():
    ...
    def test_tc14(self, androidDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.SELL, tp_type=SLTPOption.PRICE, trade_constants=TradeConstants.PRE_TRADE)
