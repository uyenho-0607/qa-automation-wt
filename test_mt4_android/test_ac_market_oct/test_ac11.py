...
class TC_aC11():
    ...
    def test_tc11(self, androidDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.SELL, sl_type=SLTPOption.POINTS, trade_constants=TradeConstants.PRE_TRADE)
