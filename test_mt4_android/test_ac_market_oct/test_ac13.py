...
class TC_aC13():
    ...
    def test_tc13(self, androidDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.SELL, tp_type=SLTPOption.POINTS, trade_constants=TradeConstants.PRE_TRADE)
