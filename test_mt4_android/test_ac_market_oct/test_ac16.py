...
from enums.main import Server, Menu, ModuleOCT, TradeDirectionOption, TradeConstants, SLTPOption, OrderPanel, SectionName
...
from common.mobileapp.module_trade.utils import toggle_radio_button, trade_market_order, modify_market_order, get_trade_snackbar_banner, extract_order_info
...
class TC_aC16():
    ...
    def test_tc16(self, androidDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.SELL, sl_type=SLTPOption.POINTS, tp_type=SLTPOption.PRICE, trade_constants=TradeConstants.PRE_TRADE)
