...
class TC_aC03():
    ...
    def test_tc03(self, androidDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.BUY, sl_type=SLTPOption.POINTS, trade_constants=TradeConstants.PRE_TRADE)
