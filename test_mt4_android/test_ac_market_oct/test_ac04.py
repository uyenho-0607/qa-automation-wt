...
class TC_aC04():
    ...
    def test_tc04(self, androidDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.BUY, sl_type=SLTPOption.PRICE, trade_constants=TradeConstants.PRE_TRADE)
