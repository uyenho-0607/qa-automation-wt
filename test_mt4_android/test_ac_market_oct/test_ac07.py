    ...
    def test_tc07(self, android_driver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.BUY, sl_type=SLTPOption.PRICE, tp_type=SLTPOption.POINTS, trade_constants=TradeConstants.PRE_TRADE)
