...
class TC_aC05():
    ...
    def test_tc05(self, androidDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.BUY, tp_type=SLTPOption.POINTS, trade_constants=TradeConstants.PRE_TRADE)
