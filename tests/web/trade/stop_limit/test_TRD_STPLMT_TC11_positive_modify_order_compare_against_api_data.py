...
def test(web, symbol, close_edit_confirm_modal, create_order_data):
    ...
    web.trade_page.modals.modify_order(trade_object, sl_type=SLTPType.random_values(), tp_type=SLTPType.random_values(), expiry=Expiry.sample_values(OrderType.LIMIT))
