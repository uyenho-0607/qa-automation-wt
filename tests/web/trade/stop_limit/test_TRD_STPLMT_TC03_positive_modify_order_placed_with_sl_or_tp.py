...
def test(web, stop_limit_obj, create_order_data, exclude_field, update_field, close_edit_confirm_modal):
    ...
    web.trade_page.asset_tab.modify_order(trade_object, **update_info, expiry=Expiry.sample_values(trade_object.order_type))
