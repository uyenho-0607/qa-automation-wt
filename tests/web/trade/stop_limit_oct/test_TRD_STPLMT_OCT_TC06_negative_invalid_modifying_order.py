...
from src.data.enums import TradeType, AssetTabs, OrderType
...
def setup_test(create_order_data, symbol):
    trade_object = ObjectTrade(order_type=OrderType.STOP_LIMIT, symbol=symbol, stop_loss=0, take_profit=0)
