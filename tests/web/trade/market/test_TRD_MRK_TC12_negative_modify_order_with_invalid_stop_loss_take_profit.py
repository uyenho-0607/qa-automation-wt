...
def test(web, invalid_field, close_edit_confirm_modal, setup_test):
    ...
    web.trade_page.modals.modify_invalid_order(trade_obj, **invalid_dict, submit=True)
...
def setup_test(create_order_data, market_obj):
    trade_obj = market_obj(stop_loss=0, take_profit=0)
