...
def test(web, symbol, edit_field, sl_type, tp_type, search_symbol, close_edit_confirm_modal, update_entry_price):
    # -------------------
    ...
    web.trade_page.place_order_panel.place_order(trade_object, sl_type=order_sl_type, tp_type=order_tp_type)
    ...
    logger.info(f" Step 3: Update {tab.title()} with {edit_field!r}")
    web.assets_page.modals.modify_order(trade_object, sl_type=sl_type, tp_type=tp_type)
