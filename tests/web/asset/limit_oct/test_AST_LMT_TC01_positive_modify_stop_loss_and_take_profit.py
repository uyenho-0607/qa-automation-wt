...
def test(web, symbol, edit_field, sl_type, tp_type, search_symbol, close_edit_confirm_modal):
    ...
    logger.info(f" Step 3: Update {tab.title()} with {edit_field!r}, expiry = {update_expiry.title()!r}")
