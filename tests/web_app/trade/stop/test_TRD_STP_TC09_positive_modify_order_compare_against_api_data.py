...
def test(web_app, symbol, create_order_data):
    ...
    web_app.trade_page.modals.modify_order(trade_object, sl_type=SLTPType.random_values(), tp_type=SLTPType.random_values(), expiry=Expiry.sample_values(OrderType.STOP), confirm=True)
