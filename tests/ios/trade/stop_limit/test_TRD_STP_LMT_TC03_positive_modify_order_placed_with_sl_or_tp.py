...
def test(ios, stop_limit_obj, exclude_field, update_field, order_data, cancel_all):
    ...
    ios.trade_screen.asset_tab.get_last_order_id(AssetTabs.PENDING_ORDER, trade_object, wait=True)
