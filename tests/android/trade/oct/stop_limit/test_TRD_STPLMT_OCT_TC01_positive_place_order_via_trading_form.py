...
def test(android, stop_limit_obj, get_asset_tab_amount, sl_type, tp_type):
    ...
    android.trade_screen.place_order_panel.place_order(trade_object, sl_type=sl_type, tp_type=tp_type, confirm=False)
