...
def test(android, order_data, market_obj, get_asset_tab_amount):
    ...
    android.trade_screen.asset_tab.full_close_position(trade_object, confirm=False)
    ...
    logger.info("Step 6: Navigate back to Trade Screen")
    ...
    logger.info(f"Step 7: Select tab {AssetTabs.HISTORY.value.capitalize()}")
