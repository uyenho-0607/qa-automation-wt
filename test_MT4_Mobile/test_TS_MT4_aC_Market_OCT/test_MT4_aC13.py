...
from common.mobileweb.module_trade.utils import button_preTrade, toggle_radioButton_OCT, trade_market_order, modify_market_order, get_trade_snackbar_banner, extract_order_info
    ...
    def test_TC13(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, trade_type="trade", option="sell", set_stopLoss=False, tp_type="points", pre_trade=True)
