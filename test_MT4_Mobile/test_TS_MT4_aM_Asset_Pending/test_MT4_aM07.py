...
from common.mobileweb.module_trade.utils import toggle_radioButton_OCT, trade_stop_order, close_delete_order, trade_ordersConfirmationDetails, get_trade_snackbar_banner, extract_order_info, button_viewAllTransaction
    ...
    def test_TC07(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, trade_type="trade", option="buy", expiryType="good-till-day", sl_type="price", set_takeProfit=False)
