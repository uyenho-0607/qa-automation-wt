...
from common.mobileweb.module_trade.utils import toggle_radioButton_OCT, trade_limit_order, modify_limit_order, get_trade_snackbar_banner, extract_order_info
from data_config.utils import compare_dataframes, process_and_print_data, append_orderIDs_to_csv


@allure.epic("MT4 Mobile TS_aE - Limit OCT")

# Member Portal 
class TC_MT4_aE10():

    @allure.title("TC_MT4_aE10")
    ...
    def test_TC10(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="sell", set_stopLoss=False, set_takeProfit=False, expiryType="good-till-cancelled", pre_trade=True)
            ...
            with allure.step("Modify Limit Order"):
                modify_limit_order(driver=main_driver, trade_type="edit", row_number=1, set_stopLoss=False, tp_type="points", expiryType="good-till-day")
            ...
            with allure.step("Retrieve the Updated Order Panel data"):
                ...
                append_orderIDs_to_csv(order_ids=updated_orderID, filename="MT4_Mobile_Limit_OCT.csv")
