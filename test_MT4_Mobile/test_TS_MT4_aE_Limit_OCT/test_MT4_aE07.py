    ...
    def test_TC07(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="buy", sl_type="price", tp_type="points", expiryType="good-till-cancelled", pre_trade=True)
            ...
            with allure.step("Modify Limit Order"):
                modify_limit_order(driver=main_driver, trade_type="edit", row_number=1, sl_type="points", tp_type="price", expiryType="good-till-day")
