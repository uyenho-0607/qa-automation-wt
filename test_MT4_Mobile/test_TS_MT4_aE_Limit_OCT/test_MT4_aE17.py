...
from common.mobileweb.module_trade.utils import toggle_radioButton_OCT, trade_limit_order, close_delete_order, get_trade_snackbar_banner, extract_order_info
    ...
    def test_TC17(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="buy", expiryType="good-till-cancelled", sl_type="price", set_takeProfit=False, pre_trade=True)
