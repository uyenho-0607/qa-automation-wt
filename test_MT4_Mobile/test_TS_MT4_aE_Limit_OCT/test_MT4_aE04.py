    ...
    def test_TC04(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="buy", sl_type="price", set_takeProfit=False, expiryType="good-till-day", pre_trade=True)
