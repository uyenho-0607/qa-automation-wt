    ...
    def test_TC13(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="sell", set_stopLoss=False, tp_type="points", expiryType="good-till-day", pre_trade=True)
            ...
            with allure.step("Modify Limit Order"):
                modify_limit_order(driver=main_driver, trade_type="edit", row_number=1, set_stopLoss=False, tp_type="points", expiryType="good-till-cancelled")
