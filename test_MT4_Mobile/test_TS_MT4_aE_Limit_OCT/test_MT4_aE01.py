    ...
    def test_TC01(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="buy", set_stopLoss=False, set_takeProfit=False, expiryType="good-till-cancelled", pre_trade=True)
            ...
            with allure.step("Retrieve the Updated Order Panel data"):
                ...
                clear_orderIDs_csv(filename="MT4_Mobile_Limit_OCT.csv")
