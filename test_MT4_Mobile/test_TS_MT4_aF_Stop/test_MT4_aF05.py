    ...
    def test_TC05(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, trade_type="trade", option="buy", set_stopLoss=False, tp_type="points",expiryType="good-till-cancelled")
            ...
            with allure.step("Modify Stop Order"):
                modify_stop_order(driver=main_driver, trade_type="edit", row_number=1, set_stopLoss=False, tp_type="points", expiryType="good-till-day")
