    ...
    def test_TC03(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, trade_type="trade", option="buy", sl_type="points", set_takeProfit=False, expiryType="good-till-cancelled")
            ...
            with allure.step("Modify Stop Order"):
                modify_stop_order(driver=main_driver, trade_type="edit", row_number=1, sl_type="points", set_takeProfit=False, expiryType="good-till-day")
