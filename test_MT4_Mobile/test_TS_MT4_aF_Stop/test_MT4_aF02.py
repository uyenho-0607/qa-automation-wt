    ...
    def test_TC02(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Modify Stop Order"):
                modify_stop_order(driver=main_driver, trade_type="edit",  row_number=1, set_stopLoss=False, tp_type="points", expiryType="good-till-cancelled")
