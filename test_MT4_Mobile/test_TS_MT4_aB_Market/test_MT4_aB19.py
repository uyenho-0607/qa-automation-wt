...
from common.mobileweb.module_trade.utils import toggle_radioButton_OCT, trade_market_order, close_delete_order, trade_ordersConfirmationDetails, get_trade_snackbar_banner, extract_order_info
from common.mobileweb.module_notification.utils import process_order_notifications
from data_config.utils import compare_dataframes, process_and_print_data


@allure.epic("MT4 Mobile TS_aB - Market")

# Member Portal
class TC_MT4_aB19():

        
    @allure.title("TC_MT4_aB19")
    ...
    def test_TC19(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, trade_type="trade", option="buy", sl_type="price", set_takeProfit=False)
            ...
            """Retrieve the New Open Position / Order History details """
            ...
            with allure.step("Retrieve and compare Order History and Notification Order Message"):
                # Call the method to get the lists of dataframes
                noti_message, noti_order_details = process_order_notifications(driver=main_driver, orderIDs=original_orderID, noti_bell = False)
