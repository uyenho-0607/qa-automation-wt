...
from common.mobileweb.module_trade.utils import toggle_radioButton_OCT, neg_trade_stop_order, get_neg_snackbar_banner
...
class TC_MT4_aP22():
    ...
    def test_TC22(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                neg_trade_stop_order(driver=main_driver, trade_type="trade", option="sell", set_stopLoss=False, set_takeProfit=False, pre_trade=True)
