...
from common.mobileweb.module_trade.utils import toggle_radioButton_OCT, neg_trade_market_order, trade_ordersConfirmationDetails, get_neg_snackbar_banner
    ...
    def test_TC08(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Loss - Price"):
                neg_trade_market_order(driver=main_driver, trade_type="trade", option="buy", set_takeProfit=False)
