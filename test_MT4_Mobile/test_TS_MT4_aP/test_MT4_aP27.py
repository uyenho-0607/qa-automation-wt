...
from common.mobileweb.module_trade.utils import toggle_radioButton_OCT, trade_stop_order, neg_modify_stop_order, get_neg_snackbar_banner, trade_ordersConfirmationDetails, get_trade_snackbar_banner, extract_order_info
...
class TC_MT4_aP27():
    ...
    @allure.title("TC_MT4_aP27")

    @allure.description(
        """
        Pending Order (Modify Stop Sell Order)
    ...
    def test_TC27(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Modify on Stop Order"):
                neg_modify_stop_order(driver=main_driver, trade_type="edit", row_number=1, set_stopLoss=False, entryPrice_flag=False)
