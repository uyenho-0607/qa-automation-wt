...
from common.mobileweb.module_trade.utils import toggle_radioButton_OCT, trade_limit_order, neg_modify_limit_order, get_neg_snackbar_banner, get_trade_snackbar_banner, extract_order_info
...
class TC_MT4_aP17():
    ...
    @allure.title("TC_MT4_aP17")

    @allure.description(
        """
        Pending Order (Modify Limit Buy Order) - OCT
    ...
    def test_TC17(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="buy", expiryType="good-till-day", set_stopLoss=False, set_takeProfit=False, pre_trade=True)
            ...
            with allure.step("Modify on Limit Order"):
                neg_modify_limit_order(driver=main_driver, trade_type="edit", row_number=1, set_takeProfit=False, entryPrice_flag=False)
