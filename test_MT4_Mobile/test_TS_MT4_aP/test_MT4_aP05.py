...
from common.mobileweb.module_trade.utils import toggle_radioButton_OCT, trade_limit_order, btn_minMax_price, btn_minMax_stopLoss, btn_minMax_takeProfit, button_orderPanel_action, get_trade_snackbar_banner, extract_order_info
    ...
    def test_TC05(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="sell", pre_trade=True, set_stopLoss=False, set_takeProfit=False, expiryType="good-till-cancelled")
