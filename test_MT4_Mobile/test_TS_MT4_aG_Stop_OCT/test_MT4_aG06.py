    ...
    def test_TC06(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, trade_type="trade", option="buy", set_stopLoss=False, tp_type="price", expiryType="good-till-day", pre_trade=True)
