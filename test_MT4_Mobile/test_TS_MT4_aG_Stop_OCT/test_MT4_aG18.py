...
from common.mobileweb.module_trade.utils import toggle_radioButton_OCT, trade_stop_order, close_delete_order, get_trade_snackbar_banner, extract_order_info
    ...
    def test_TC18(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, trade_type="trade", option="sell", expiryType="good-till-day", set_stopLoss=False, tp_type="price", pre_trade=True)
