    ...
    def test_TC14(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, trade_type="trade", option="sell", set_stopLoss=False, tp_type="price", expiryType="good-till-cancelled", pre_trade=True)
