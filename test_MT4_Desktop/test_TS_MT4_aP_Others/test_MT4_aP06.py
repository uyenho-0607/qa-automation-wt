...
from common.desktop.module_trade.utils import toggle_radioButton, button_tradeModule, button_buy_sell_type, dropdown_orderType, verify_volume_minMax_buttons, btn_minMax_price, btn_minMax_stopLoss, btn_minMax_takeProfit
    ...
    def test_TC06(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Increase / Decrease Size"):
                verify_volume_minMax_buttons(driver=main_driver, trade_type="trade", actions=[("increase", 5), ("decrease", 3)])
