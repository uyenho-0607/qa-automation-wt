...
from common.desktop.module_trade.utils import toggle_radioButton_OCT, trade_market_order, get_neg_snackbar_banner
    ...
    def test_TC09(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Take Profit - Price"):
                trade_market_order(driver=main_driver, trade_type="trade", option="buy", set_stopLoss=False, takeProfit_flag=False, tp_type="price")
