...
from common.desktop.module_trade.utils import toggle_radioButton_OCT, neg_trade_stop_order, get_neg_snackbar_banner, trade_ordersConfirmationDetails
...
class TC_MT4_aP21():
    ...
    def test_TC21(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                neg_trade_stop_order(driver=main_driver, trade_type="trade", option="buy", set_takeProfit=False, entryPrice_flag=False)
