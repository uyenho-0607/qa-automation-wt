...
class TC_MT4_aY99():
    ...
    def test_TC99(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Login to Web Trader Membersite"):
                login_username = login_wt(driver=main_driver, server="MT4", client_name="Lirunex", account_type="live", testcaseID="TC02")
            ...
            with allure.step("Change Password - New password does not match confirm password"):
                change_password(driver=main_driver, old_password="Asd123", new_password="Asdf!234567899", confirm_password="Asdf!23456789")
     
            with allure.step("Change Password - New password cannot be the same as previous 5 old password"):
                change_password(driver=main_driver, old_password="Asd123", new_password="Asdf!23456789", confirm_password="Asdf!23456789")

            with allure.step("Change Password - Account password has been updated successfully"):
                change_password(driver=main_driver, old_password="Asd123333", new_password="Asdf!112345678889", confirm_password="Asdf!112345678889", alert_type="success", login_username=login_username)
