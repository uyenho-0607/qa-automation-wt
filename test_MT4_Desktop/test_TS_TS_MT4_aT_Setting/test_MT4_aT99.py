    ...
    def test_TC11(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Change Password - New password cannot be the same as previous 5 old password"):
                change_password(driver=main_driver, old_password="Asd123", new_password="Asdf!12345654321", confirm_password="Asdf!12345654321")

            with allure.step("Change Password - Account password has been updated successfully"):
                change_password(driver=main_driver, old_password="Asd123", new_password="Asdf!22211122333", confirm_password="Asdf!22211122333", 
                                alert_type="success", login_username=login_username, login_password="Asdf!22211122333", params_wt_url=params_wt_url)
