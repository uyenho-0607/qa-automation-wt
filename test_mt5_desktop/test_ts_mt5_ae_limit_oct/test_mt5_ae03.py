    ...
    def test_tc03(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="buy", sl_type="points", set_takeProfit=False, expiryType="specified-date", expiryDate="19", targetMonth=parse("April 2025"), specifiedDate=True)
