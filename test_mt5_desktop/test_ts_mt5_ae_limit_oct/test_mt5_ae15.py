...
class TC_aE15():
    ...
    def test_tc15(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, option=TradeDirectionOption.SELL, sl_type=SLTPOption.PRICE, tp_type=SLTPOption.POINTS, expiry_type=ExpiryType.SPECIFIED_DATE, expiry_date="19", target_month=parse("April 2025"))
            ...
            with allure.step("Modify on Limit Order"):
                modify_limit_order(driver=main_driver, sl_type=SLTPOption.POINTS, tp_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_CANCELLED)
