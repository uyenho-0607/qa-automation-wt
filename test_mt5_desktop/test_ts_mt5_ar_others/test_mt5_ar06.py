...
from common.desktop.module_trade.utils import toggle_radio_button, button_tradeModule, dropdown_orderType, button_buy_sell_type, verify_volume_minMax_buttons, btn_minMax_price, btn_minMax_stopLimitPrice, btn_min_max_stop_loss, btn_minMax_takeProfit
    ...
    def test_tc06(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Increase / Decrease Stop Limit Price"):
                btn_minMax_stopLimitPrice(driver=main_driver, trade_type="trade", minMax="decrease", number_of_clicks=5)
                btn_minMax_stopLimitPrice(driver=main_driver, trade_type="trade", minMax="increase", number_of_clicks=3)
