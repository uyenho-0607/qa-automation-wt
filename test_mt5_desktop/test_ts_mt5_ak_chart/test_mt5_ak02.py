...
from common.desktop.module_trade.utils import toggle_radio_button, trade_market_order, trade_ordersConfirmationDetails, get_trade_snackbar_banner, extract_order_info
    ...
    def test_tc02(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, trade_type="trade", option="buy", set_Chart=True, chart_fullscreen="toggle", set_fillPolicy=True, sl_type="price", tp_type="points")
