...
from enums.main import Server, ButtonModuleType, TradeConstants, TradeDirectionOption, SLTPOption, OrderPanel, SectionName
...
from common.desktop.module_trade.utils import toggle_radio_button, trade_market_order, trade_orders_confirmation_details, get_trade_snackbar_banner, extract_order_info
...
class TC_aK02():
    ...
    @allure.title("TC_aK02")
        
    @allure.description(
        """
        Sell Order

        Member able to submit a Market Sell order
        - Volume
        - Stop Loss by Price
    ...
    def test_tc02(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.BUY, chart_fullscreen="toggle", trade_constants=TradeConstants.SET_FILL_POLICY, sl_type=SLTPOption.PRICE, tp_type=SLTPOption.POINTS)
            ...
            with allure.step("Retrieve and compare Open Position and Notification Order Message / Details"):
                ...
                compare_dataframes(driver=main_driver, df1=open_position_df, name1=SectionName.TRADE_OPEN_POSITION, df2=noti_msg_df, name2=SectionName.NOTIFICATION_ORDER_MESSAGE)
                ...
                compare_dataframes(driver=main_driver, df1=open_position_df, name1=SectionName.TRADE_OPEN_POSITION, df2=noti_order_df, name2=SectionName.NOTIFICATION_ORDER_DETAIL)

            with allure.step("Print Final Result"):
                process_and_print_data(open_position_df, trade_confirmation_df, snackbar_banner_df, noti_msg_df, noti_order_df)
