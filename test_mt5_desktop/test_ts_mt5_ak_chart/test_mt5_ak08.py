...
from enums.main import Server, ButtonModuleType, TradeConstants, TradeDirectionOption, ExpiryType, OrderPanel, SectionName
...
class TC_aK08():
    ...
    @allure.title("TC_aK08")
        
    @allure.description(
        """
        Sell Order
        
        Member able to place a Stop Limit order via Chart
        - Size
        - Price
    ...
    def test_tc08(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stop_limit_order(driver=main_driver, option=TradeDirectionOption.SELL, expiry_type=ExpiryType.GOOD_TILL_CANCELLED, chart_fullscreen="toggle")
