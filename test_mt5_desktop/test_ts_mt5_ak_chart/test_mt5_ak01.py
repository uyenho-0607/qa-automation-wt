...
class TC_aK01():
    ...
    @allure.title("TC_aK01")
        
    @allure.description(
        """
        Buy Order

        Member able to submit a Market Buy order
        - Volume
        - Stop Loss by Points
    ...
    def test_tc01(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.BUY, chart_fullscreen="toggle", trade_constants=TradeConstants.SET_FILL_POLICY, sl_type=SLTPOption.POINTS, tp_type=SLTPOption.PRICE)
