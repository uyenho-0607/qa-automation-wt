...
from enums.main import Server, Menu, TradeConstants, TradeDirectionOption, SLTPOption, ExpiryType, OrderPanel, SectionName
...
from common.desktop.module_trade.utils import toggle_radio_button, trade_limit_order, modify_limit_order, get_trade_snackbar_banner, extract_order_info
    ...
    def test_tc02(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, option=TradeDirectionOption.SELL, sl_type=SLTPOption.POINTS, expiry_type=ExpiryType.GOOD_TILL_CANCELLED)
            ...
            with allure.step("Modify Limit Order"):
                modify_limit_order(driver=main_driver, sl_type=SLTPOption.PRICE, tp_type=SLTPOption.POINTS, expiry_type=ExpiryType.GOOD_TILL_DAY)
