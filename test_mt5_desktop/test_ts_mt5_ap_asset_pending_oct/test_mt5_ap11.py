...
from common.desktop.module_trade.utils import toggle_radio_button, trade_stopLimit_order, close_delete_order, get_trade_snackbar_banner, extract_order_info
    ...
    def test_tc11(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stopLimit_order(driver=main_driver, trade_type="trade", option="buy", expiryType="good-till-cancelled", sl_type="price", set_takeProfit=False)
