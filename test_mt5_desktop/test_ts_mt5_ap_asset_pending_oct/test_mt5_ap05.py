    ...
    def test_tc05(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Modify Limit Order"):
                modify_stop_limit_order(driver=main_driver, sl_type=SLTPOption.PRICE, tp_type=SLTPOption.POINTS, expiry_type=ExpiryType.GOOD_TILL_CANCELLED)
