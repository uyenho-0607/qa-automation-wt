    ...
    def test_tc16(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, trade_type="trade", option="sell", sl_type="points", tp_type="price", expiryType="specified-date-and-time", expiryDate="19", targetMonth=parse("April 2025"), hour_option="11", min_option="35", specifiedDate=True)
            ...
            with allure.step("Modify on Stop Order"):
                modify_stop_order(driver=main_driver, trade_type="edit", row_number=[1], sl_type="price", tp_type="points", expiryType="specified-date-and-time", expiryDate="19", targetMonth=parse("April 2025"), hour_option="11", min_option="35", specifiedDate=True)
