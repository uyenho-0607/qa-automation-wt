    ...
    def test_tc14(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, option=TradeDirectionOption.SELL, tp_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_DAY)
            ...
            with allure.step("Modify Stop Order"):
                modify_stop_order(driver=main_driver, tp_type=SLTPOption.PRICE, expiry_type=ExpiryType.SPECIFIED_DATE, expiry_date="19", target_month=parse("April 2025"))
