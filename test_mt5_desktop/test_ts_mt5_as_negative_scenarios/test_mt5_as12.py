...
from common.desktop.module_trade.utils import toggle_radio_button, trade_limit_order, modify_limit_order, get_neg_snackbar_banner, trade_orders_confirmation_details, get_trade_snackbar_banner, extract_order_info
    ...
    def test_tc12(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, option=TradeDirectionOption.SELL, expiry_type=ExpiryType.GOOD_TILL_DAY)
            ...
            with allure.step("Modify on Limit Order"):
                modify_limit_order(driver=main_driver, tp_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_CANCELLED, take_profit_flag=AlertType.NEGATIVE)
