...
from enums.main import Server, ButtonModuleType, TradeDirectionOption, SLTPOption, AlertType
from constants.helper.driver import shutdown
from constants.helper.screenshot import attach_session_video_to_allure, attach_text

from common.desktop.module_login.utils import login_wt
from common.desktop.module_symbol.utils import input_symbol
from common.desktop.module_trade.utils import toggle_radio_button, trade_market_order, trade_orders_confirmation_details, get_neg_snackbar_banner
    ...
    def test_tc01(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Loss - Price"):
                trade_market_order(driver=main_driver, option=TradeDirectionOption.BUY, sl_type=SLTPOption.PRICE, stop_loss_flag = AlertType.NEGATIVE)
