...
from enums.main import Server, ButtonModuleType, TradeDirectionOption, ExpiryType, OrderPanel, SectionName, AlertType
...
class TC_aS30():
    ...
    def test_tc30(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Modify on Stop Limit Order"):
                modify_stop_limit_order(driver=main_driver, expiry_type=ExpiryType.GOOD_TILL_CANCELLED, entry_price_flag=AlertType.NEGATIVE)
