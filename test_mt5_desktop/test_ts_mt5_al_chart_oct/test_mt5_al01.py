...
@allure.epic("MT5 Desktop ts_al - Chart OCT - Order Placing Window")

# Member Portal
class TC_aL01():

                
    @allure.title("TC_aL01")
    ...
    def test_tc01(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_oct_market_order(driver=main_driver, option=TradeDirectionOption.BUY, chart_fullscreen="toggle")
            ...
            with allure.step("Retrieve and compare Open Position and Notification Order Message / Details"):
                ...
                compare_dataframes(driver=main_driver, df1=open_position_df, name1=SectionName.TRADE_OPEN_POSITION,
                                   df2=noti_order_df, name2=SectionName.NOTIFICATION_ORDER_DETAIL)
