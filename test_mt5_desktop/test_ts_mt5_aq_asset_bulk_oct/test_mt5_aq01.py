    ...
    def test_tc01(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Bulk Close Orders"):
                ...
                open_position_df = button_bulk_operation(driver=main_driver, filename=CSVFileNameManager.MT5_DESKTOP_BULK, bulk_type=BulkActionType.BULK_CLOSE, options_dropdown=BulkActionType.ALL, section_name=SectionName.ASSET_OPEN_POSITION, tab_order_type=OrderPanel.OPEN_POSITIONS)
