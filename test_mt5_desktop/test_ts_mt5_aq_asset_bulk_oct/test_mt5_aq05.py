...
from enums.main import Server, Menu, OrderPanel, SectionName
    ...
    def test_tc05(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Bulk Delete Orders"):
                ...
                pending_order_df = button_bulk_operation(driver=main_driver, filename="MT5_Bulk.csv", bulk_type="delete", section_name=SectionName.ASSET_PENDING_ORDER, tab_order_type=OrderPanel.PENDING_ORDERS, symbol_name_element=True, set_trade=False, set_sorting=True)
