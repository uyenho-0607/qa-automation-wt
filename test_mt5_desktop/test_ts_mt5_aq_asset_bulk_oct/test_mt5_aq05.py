    ...
    def test_tc05(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Bulk Delete Orders"):
                ...
                pending_order_df = button_bulk_operation(driver=main_driver, filename=CSVFileNameManager.MT5_DESKTOP_BULK, bulk_type=BulkActionType.BULK_DELETE, section_name=SectionName.ASSET_PENDING_ORDER, tab_order_type=OrderPanel.PENDING_ORDERS, set_sorting=True)
