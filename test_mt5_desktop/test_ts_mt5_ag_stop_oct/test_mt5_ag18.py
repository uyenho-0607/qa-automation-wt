    ...
    def test_tc18(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, option=TradeDirectionOption.SELL, expiry_type=ExpiryType.GOOD_TILL_DAY, tp_type=SLTPOption.PRICE)
