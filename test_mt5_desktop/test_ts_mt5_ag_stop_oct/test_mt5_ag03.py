    ...
    def test_tc03(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, option=TradeDirectionOption.BUY, sl_type=SLTPOption.POINTS, expiry_type=ExpiryType.SPECIFIED_DATE, expiry_date="19", target_month=parse("April 2025"))
            ...
            with allure.step("Modify Stop Order"):
                modify_stop_order(driver=main_driver, sl_type=SLTPOption.POINTS, expiry_type=ExpiryType.GOOD_TILL_DAY)
