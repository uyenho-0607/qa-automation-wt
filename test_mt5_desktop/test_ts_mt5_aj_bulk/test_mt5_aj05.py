...
from enums.main import Server, OrderPanel, SectionName
    ...
    def test_tc05(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Bulk Delete Orders"):
                ...
                pending_order_df = button_bulk_operation(driver=main_driver, filename="MT5_Bulk.csv", bulk_type="delete", section_name=SectionName.TRADE_PENDING_ORDER, tab_order_type=OrderPanel.PENDING_ORDERS, set_sorting=True)
            ...
            with allure.step("Ensure the OrderID is display in order panel: Order History table"):
                ...
                order_history_df = check_orderIDs_in_table(driver=main_driver, order_ids=csv_orderIDs, tab_order_type=OrderPanel.ORDER_AND_DEALS, section_name=SectionName.ORDER_HISTORY)
