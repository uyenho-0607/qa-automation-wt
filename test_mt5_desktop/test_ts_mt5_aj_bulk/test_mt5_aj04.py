    ...
    def test_tc04(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Bulk Delete Orders"):
                ...
                pending_order_df = button_bulk_operation(driver=main_driver, filename=CSVFileNameManager.MT5_DESKTOP_BULK, bulk_type=BulkActionType.BULK_DELETE, section_name=SectionName.TRADE_PENDING_ORDER, tab_order_type=OrderPanel.PENDING_ORDERS)
