    ...
    def test_tc13(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Login to Web Trader Membersite"):
                params_wt_url, login_username, _  = login_wt(driver=main_driver, server=Server.MT5, account_type="live", testcase_id="TC02")
            ...
            with allure.step("Change Password - Password format is incorrect."):
                change_password(driver=main_driver, old_password="Asdf!234", new_password="Asdf!", confirm_password="Asdf!")

            with allure.step("Change Password - New password does not match confirm password"):
                change_password(driver=main_driver, old_password="Asdf!234", new_password="Asdf!234567811", confirm_password="Asdf!23456789")
     
            with allure.step("Change Password - New password cannot be the same as previous 5 old password"):
                change_password(driver=main_driver, old_password="Asdf!234", new_password="Asdf!2221117733", confirm_password="Asdf!2221117733")

            with allure.step("Change Password - Account password has been updated successfully"):
                change_password(driver=main_driver, old_password="Asdf!234", new_password="Asdf!22411171733", confirm_password="Asdf!22411171733", 
