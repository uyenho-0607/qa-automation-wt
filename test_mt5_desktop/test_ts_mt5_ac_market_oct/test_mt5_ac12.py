...
from enums.main import Server, TradeDirectionOption, TradeConstants, SLTPOption, OrderPanel, SectionName
...
from common.desktop.module_trade.utils import toggle_radio_button, trade_market_order, modify_market_order, get_trade_snackbar_banner, extract_order_info
...
class TC_aC12():
    ...
    def test_tc12(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Market Order with Stop Loss by Price"):
