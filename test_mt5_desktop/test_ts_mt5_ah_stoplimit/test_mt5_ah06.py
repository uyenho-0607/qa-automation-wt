    ...
    def test_tc06(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stop_limit_order(driver=main_driver, option=TradeDirectionOption.BUY, tp_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_DAY)
            ...
            with allure.step("Modify Stop Limit Order"):
                modify_stop_limit_order(driver=main_driver, tp_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_DAY)
