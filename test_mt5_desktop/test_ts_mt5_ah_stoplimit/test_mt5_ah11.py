    ...
    def test_tc11(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stop_limit_order(driver=main_driver, option=TradeDirectionOption.SELL, sl_type=SLTPOption.POINTS, expiry_type=ExpiryType.SPECIFIED_DATE, expiry_date="19", target_month=parse("April 2025"))
            ...
            with allure.step("Modify Stop Limit Order"):
                modify_stop_limit_order(driver=main_driver, sl_type=SLTPOption.POINTS, expiry_type=ExpiryType.SPECIFIED_DATE, expiry_date="19", target_month=parse("April 2025"))
