...
from enums.main import Server, ButtonModuleType, TradeConstants, TradeDirectionOption, SLTPOption, ExpiryType, OrderPanel, SectionName, CSVFileNameManager
...
@allure.epic("MT5 Desktop ts_ah - Stop Limit")

# Member Portal
class TC_aH14():

    @allure.title("TC_aH14")
    ...
    def test_tc14(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stop_limit_order(driver=main_driver, option=TradeDirectionOption.SELL, tp_type=SLTPOption.PRICE, expiry_type=ExpiryType.GOOD_TILL_DAY)
            ...
            with allure.step("Modify Stop Limit Order"):
                modify_stop_limit_order(driver=main_driver, tp_type=SLTPOption.PRICE, expiry_type=ExpiryType.SPECIFIED_DATE, expiry_date="19", target_month=parse("April 2025"))
