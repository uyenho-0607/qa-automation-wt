    ...
    def test_tc13(self, chrome_driver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stop_limit_order(driver=main_driver, option=TradeDirectionOption.SELL, tp_type=SLTPOption.POINTS, expiry_type=ExpiryType.GOOD_TILL_CANCELLED)
            ...
            with allure.step("Modify Stop Limit Order"):
                modify_stop_limit_order(driver=main_driver, tp_type=SLTPOption.POINTS, expiry_type=ExpiryType.GOOD_TILL_DAY)
