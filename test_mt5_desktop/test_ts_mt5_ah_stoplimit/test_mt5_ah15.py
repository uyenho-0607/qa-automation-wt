    ...
    def test_tc15(self, chromeDriver, request):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stopLimit_order(driver=main_driver, trade_type="trade", option="sell", sl_type="price", tp_type="points", expiryType="specified-date", expiryDate="19", targetMonth=parse("April 2025"), specifiedDate=True)
