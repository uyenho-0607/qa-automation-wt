...
def launch_bo(driver, platform: str, client_name: str, device_type: str, env_type: str) -> None:
    try:
        urls = get_URLs()
...
def bo_user_login(driver, platform: str, client_name: str, testcaseID: str, expect_failure: bool = False, max_retries: int = 10) -> None:
    try:
        ...
        if platform in data:
            platform_data = data[platform].get(client_name, {}).get("AdminPortal", {})
...
def login_bo(driver, platform: str, client_name: str, testcaseID: str = None, device_type: str = "Backoffice", env_type: str = "Release_SIT", expect_failure: bool = False, max_retries: int = 10) -> None:
    try:
        
        launch_bo(driver, platform, client_name, device_type, env_type)
        
        bo_user_login(driver, platform, client_name, testcaseID, expect_failure, max_retries)
