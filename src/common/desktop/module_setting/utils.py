...
from common.desktop.module_setting.setting_change_language import configure_language_setting
...
from common.desktop.module_setting.setting_demo_account import open_demo_account_error_msg, open_demo_account_screen, demo_account_ready_screen, handle_sign_in, validate_account_details
