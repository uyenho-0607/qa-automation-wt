...
def handle_pre_selected_tab(driver):
    try:
        ...
        if selected_tab_text == "Favourites":
            ...
            favourites_tab = find_element_by_testid(driver, "tab-my-watchlist")
            if favourites_tab:
                favourites_tab.click()
                symbols_in_favourites = find_list_of_elements_by_testid(driver, data_testid="watchlist-symbol")
