...
def trade_market_order(driver, trade_type, option, chart_fullscreen=None, sl_type=None, tp_type=None, set_fillPolicy: bool = False, set_stopLoss: bool = True, set_takeProfit: bool = True, set_Chart: bool = False):
    try:
