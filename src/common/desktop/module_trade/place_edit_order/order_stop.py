...
def trade_stop_order(driver, option: TradeDirectionOption, expiry_type: ExpiryType, trade_type: ButtonModuleType = ButtonModuleType.TRADE, 
                     expiry_date=None, target_month=None, hour_option=None, min_option=None, sl_type=None, tp_type=None, chart_fullscreen=None, 
                     trade_constants: TradeConstants = TradeConstants.NONE, order_type: OrderExecutionType = OrderExecutionType.STOP,
...
def modify_stop_order(driver, expiry_type: ExpiryType, trade_type: ButtonModuleType = ButtonModuleType.EDIT, 
