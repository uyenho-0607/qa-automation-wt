...
from common.desktop.module_trade.place_edit_order.order_limit import calculate_limit_entryPrice, calculate_limit_stopLoss, calculate_limit_takeProfit, trade_limit_order, modify_limit_order
...
from common.desktop.module_trade.place_edit_order.order_stop import calculate_stop_entryPrice, calculate_stop_stopLoss, calculate_stop_takeProfit, trade_stop_order, modify_stop_order
from common.desktop.module_trade.place_edit_order.order_stoplimit import store_stopLimitPrice, calculate_stopLimit_entryPrice, calculate_stopLimit_Price, calculate_stopLimit_stopLoss, calculate_stopLimit_takeProfit, trade_stopLimit_order, modify_stopLimit_order
