...
def neg_trade_limit_order(driver, trade_type, option, sl_type="price", tp_type="price", set_entryPrice: bool = True, entryPrice_flag: bool = True,set_stopLoss: bool = True, set_takeProfit: bool = True):
    try:
