from enums.main import ModuleOCT
from constants.element_ids import DataTestID

from constants.helper.driver import delay
from constants.helper.screenshot import attach_text
from constants.helper.error_handler import handle_exception
from constants.helper.element_android_app import spinner_element, click_element, find_element_by_testid_with_wait
...
def toggle_radio_button(driver, desired_state: ModuleOCT = ModuleOCT.UNCHECKED):
    try:
        ...
        radio_states = {
            ModuleOCT.UNCHECKED: DataTestID.TOGGLE_OCT,
            ModuleOCT.CHECKED: DataTestID.TOGGLE_OCT_CHECKED
        }
        ...
        for state, testid in radio_states.items():
            try:
                ...
                oct_button = find_element_by_testid_with_wait(driver, testid)
                current_state = state
                ...
                if desired_state == ModuleOCT.CHECKED:
                    oct_confirm = find_element_by_testid_with_wait(driver, data_testid=DataTestID.OCT_MODAL_BUTTON_CONFIRM)
