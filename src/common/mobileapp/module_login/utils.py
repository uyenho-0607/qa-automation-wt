from common.mobileapp.module_login.login import splash_screen, check_symbol_element_present, select_account_type, wt_user_login, handle_login_result, handle_alert_error, login_wt
