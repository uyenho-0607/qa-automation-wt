...
def neg_trade_stop_order(driver, trade_type, option, sl_type="price", tp_type="price", pre_trade: bool = False, set_entryPrice: bool = True, entryPrice_flag : bool = True, set_stopLoss: bool = True, set_takeProfit: bool = True):
    try:
