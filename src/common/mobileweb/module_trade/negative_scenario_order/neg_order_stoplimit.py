...
from common.mobileweb.module_trade.order_placing_window.utils import trade_placingModal, input_size_volume, handle_entryPrice, handle_stopLimitPrice, handle_stopLoss, handle_takeProfit
...
def neg_trade_stopLimit_order(driver, trade_type, option, sl_type="price", tp_type="price", pre_trade: bool = False, set_entryPrice: bool = True, entryPrice_flag: bool = True, stopLimitPrice_flag: bool = True, set_stopLimitPrice:bool = True, set_stopLoss: bool = True, set_takeProfit: bool = True):
    try:
