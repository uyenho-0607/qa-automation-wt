...
from common.mobileweb.module_trade.place_edit_order.price_related import get_current_price, get_edit_order_label, pointsDistance
...
from common.mobileweb.module_trade.order_placing_window.utils import trade_placingModal, input_size_volume, fillPolicy_type, handle_stopLoss, handle_takeProfit
...
def neg_trade_market_order(driver, trade_type, option, sl_type="price", tp_type="price", pre_trade: bool = False, set_fillPolicy: bool = False, set_stopLoss: bool = True, set_takeProfit: bool = True):
    try:
