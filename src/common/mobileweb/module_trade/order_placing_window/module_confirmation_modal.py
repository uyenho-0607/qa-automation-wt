...
from constants.helper.element import click_element_with_wait, find_element_by_xpath, find_element_by_testid, find_list_of_elements_by_xpath, find_list_of_elements_by_testid, visibility_of_element_by_xpath, get_label_of_element
...
def trade_ordersConfirmationDetails(driver, trade_type):
    try:
        ...
        visibility_of_element_by_xpath(driver, "//div[contains(@data-testid, 'confirmation-label')]")
        ...
        trade_order_details = extract_order_data_details(driver, result, trade_confirmation_headers, section_name="Trade Confirmation Details")
