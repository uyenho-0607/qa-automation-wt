from constants.helper.element import click_element, clear_input_field, find_element_by_testid, populate_element_with_wait, visibility_of_element_by_testid
...
def handle_takeProfit(driver, trade_type, tp_type):
    ...
    takeProfit_element = visibility_of_element_by_testid(driver, data_testid=f"{trade_type}-input-takeprofit-{tp_type}")
...
def btn_minMax_takeProfit(driver, trade_type, type, minMax, number_of_clicks):
    try:
        ...
        button_minMax = visibility_of_element_by_testid(driver, data_testid=f"{trade_type}-input-takeprofit-{type}-{minMax}")
