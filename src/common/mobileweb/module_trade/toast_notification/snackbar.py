...
from constants.helper.element import click_element, click_element_with_wait, get_label_of_element, spinner_element, visibility_of_element_by_testid, find_element_by_testid
...
def get_trade_snackbar_banner(driver):
    try:
        ...
        closeBtn = visibility_of_element_by_testid(driver, data_testid="notification-box-close")
