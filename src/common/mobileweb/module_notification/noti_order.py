...
from common.mobileweb.module_notification.noti_general import notification_bell
from common.mobileweb.module_trade.order_panel.op_general import extract_order_data_details, get_table_headers
...
def get_orderNotification_msg(driver, order_id, noti_bell: bool):
    try:
        ...
        visibility_of_element_by_testid(driver, data_testid="notification-list-result-item")
...
def get_noti_ordersDetails(driver):
    ...
    try:
        ...
        order_type = visibility_of_element_by_testid(driver, data_testid="notification-order-details-modal-order-type")
        order_type_result = re.search(r'\b(BUY|SELL)\b', order_type.text).group()
        ...
        modal_close = find_element_by_testid(driver, data_testid="navigation-back-button")
