...
class PasswordModal(BaseScreen):
    ...
    # ------------------------ LOCATORS ------------------------ #
    __txt_old_password = (AppiumBy.ACCESSIBILITY_ID, "change-password-modal-old-password")
    __txt_new_password = (AppiumBy.ACCESSIBILITY_ID, "change-password-modal-new-password")
    __txt_confirm_new_password = (AppiumBy.ACCESSIBILITY_ID, "change-password-modal-confirm-new-password")
    __btn_confirm = (AppiumBy.ACCESSIBILITY_ID, "change-password-modal-confirm")
