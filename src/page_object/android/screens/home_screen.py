...
class HomeScreen(BaseScreen):
    ...
    # ------------------------ LOCATORS ------------------------ #
    __account_selector = (AppiumBy.ID, 'account-selector')
    __account_type_tag = (AppiumBy.ID, 'account-type-tag')

    __available_balance_dropdown = (AppiumBy.ID, 'available-balance-dropdown')
    __available_account_amount = (AppiumBy.ID, 'available-balance-amount')
    __available_balance_title = (AppiumBy.ID, 'available-balance-title')

    __symbol_search_selector = (AppiumBy.ID, 'symbol-search-selector')
    __txt_symbol_search = (AppiumBy.ID, 'symbol-input-search')
    __item_search_result = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("watchlist-symbol").textContains("{}")')
    __items_search_result = (AppiumBy.ID, 'symbol-input-search-items')
    ...
    __btn_search_cancel = (AppiumBy.ID, 'symbol-input-search-cancel')
    ...
    __notification_selector = (AppiumBy.ID, 'notification-selector')
