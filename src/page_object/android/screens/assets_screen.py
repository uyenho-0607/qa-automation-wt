...
class AssetsScreen(BaseScreen):
    ...
    # ------------------------ LOCATORS ------------------------ #
    __acc_name = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("account-name")')
    __acc_id = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("account-id")')
    __acc_type = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("account-type-tag")')
    __acc_details = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("account-detail")')
    ...
    __item_watchlist = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("watchlist-symbol")')
    __view_transaction = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("asset-header-view-all")')
