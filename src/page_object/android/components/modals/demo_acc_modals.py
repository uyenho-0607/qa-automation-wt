...
class DemoAccountModal(BaseScreen):
    ...
    # ------------------------ LOCATORS ------------------------ #
    __opt_setting = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("setting-option-{}")')

    # ======================== DEMO ACCOUNT CREATION LOCATORS ======================== #
    __txt_name = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("demo-account-creation-modal-name")')
    __txt_email = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("demo-account-creation-modal-email")')

    __drp_country_dial_code = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("demo-account-creation-modal-dial-code")')
    __txt_country_search = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("country-dial-code-search")')
    ...
    __txt_phone_number = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("demo-account-creation-modal-phone")')
    __deposit = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("demo-account-creation-modal-deposit")')
    __item_deposit = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("deposit-dropdown-item").description("{}")')
    __btn_agree_and_continue = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("demo-account-creation-modal-confirm")')
    __field_validation = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("input-field-validation")')
    ...
    # Locators
    __demo_acc_completion_title = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("demo-account-completion-modal-title")')
    ...
    __btn_sign_in_demo_acc_completion = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("demo-completion-sign-in")')
    __btn_switch_to_demo_acc = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().text("SWITCH TO DEMO ACCOUNT")')
    __btn_demo_acc_completion_done = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("demo-completion-done")')
