...
class DemoAccountModal(BaseScreen):
    ...
    __demo_acc_userid = (AppiumBy.XPATH, '//android.widget.TextView[@resource-id="demo-completion-label" and @text="Login"]/following-sibling::android.widget.TextView')
    __demo_acc_password = (AppiumBy.XPATH, '//android.widget.TextView[@resource-id="demo-completion-label" and @text="Password"]/following-sibling::android.widget.TextView')
    __demo_acc_name = (AppiumBy.XPATH, '//android.widget.TextView[@resource-id="demo-completion-label" and @text="Name"]/following-sibling::android.widget.TextView')
