...
class Settings(BaseScreen):
    ...
    # ------------------------ LOCATORS ------------------------ #
    __btn_account_selector = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("account-selector")')
    __txt_account_name = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("account-name")')
    __txt_account_id = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("account-id")')
    __txt_account_detail = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("account-detail")')
    ...
    __btn_help_support = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("setting-option-help-support")')
    __btn_about = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("setting-option-about")')
    __btn_logout = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("account-logout")')
