    ...
    def test_TC02(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Modify Limit Order"):
                modify_limit_order(driver=main_driver, trade_type="edit", row_number=[1], set_stopLoss=False, tp_type="price", expiryType="specified-date-and-time", expiryDate="19", targetMonth=parse("Feb 2025"), hour_option="11", min_option="35", specifiedDate=True)
