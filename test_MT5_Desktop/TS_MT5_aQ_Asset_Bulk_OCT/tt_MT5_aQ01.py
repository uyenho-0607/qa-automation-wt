    ...
    def test_TC01(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Bulk Close Orders"):
                ...
                open_position_df = button_bulk_operation(driver=main_driver, filename="MT5_Bulk.csv", bulk_type="close", options_dropdown="all", section_name="Open Position", symbol_name_element=True)
