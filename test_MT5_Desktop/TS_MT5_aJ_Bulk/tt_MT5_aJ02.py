...
class TC_MT5_aJ02():
    ...
    @allure.title("TC_MT5_aJ02")

    @allure.description(
        """
        Member able to Bulk Close Market order - Profit in Market Page
        """
        )
    ...
    def test_TC02(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Bulk Close Orders"):
                ...
                open_position_df = button_bulk_operation(driver=main_driver, filename="MT5_Bulk.csv", bulk_type="close", options_dropdown="profit", section_name="Open Position")
