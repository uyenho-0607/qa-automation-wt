...
from common.desktop.module_trade.utils import toggle_radioButton_OCT, trade_market_order, modify_market_order, get_trade_snackbar_banner, extract_order_info
    ...
    def test_TC05(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order with Take Profit by Points"):
                trade_market_order(driver=main_driver, trade_type="trade", option="buy", set_fillPolicy=True, set_stopLoss=False, tp_type="points")
            ...
            with allure.step("Modify on Market Order"):
                modify_market_order(driver=main_driver, trade_type="edit", row_number=[1], set_stopLoss=False, tp_type="points")
