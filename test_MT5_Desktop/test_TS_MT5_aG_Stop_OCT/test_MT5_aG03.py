    ...
    def test_tc03(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, trade_type="trade", option="buy", sl_type="points", set_takeProfit=False, expiryType="specified-date", expiryDate="19", targetMonth=parse("Feb 2025"), specifiedDate=True)
