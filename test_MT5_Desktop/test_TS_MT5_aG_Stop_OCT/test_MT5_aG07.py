    ...
    def test_TC07(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, trade_type="trade", option="buy", sl_type="price", tp_type="points", expiryType="specified-date", expiryDate="19", targetMonth=datetime.strptime("Nov 2024", "%b %Y"), specifiedDate=True)
