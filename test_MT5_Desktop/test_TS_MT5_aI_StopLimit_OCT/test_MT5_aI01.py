...
class TC_MT5_aI01():
    ...
    @allure.title("TC_MT5_aI01")

    @allure.description(
        """
        Buy Order
        
        Member able to place a StopLimit order with
        - Volume
        - Price
        - Expiry: Good Till Cancelled

        Member able to modify a StopLimit order with
        - Price
        - Stop Loss by Price
        - Expiry: Good Till Cancelled
        """
    ...
    def test_TC01(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place StopLimit Order"):
            ...
            """End of Place StopLimit Order """

            """ Start of modifying Pending Order """

            with allure.step("Modify StopLimit Order"):
            ...
            with allure.step("Retrieve the Updated Order Panel data"):
                ...
                clear_orderIDs_csv(filename="MT5_Desktop_StopLimit_OCT.csv")
