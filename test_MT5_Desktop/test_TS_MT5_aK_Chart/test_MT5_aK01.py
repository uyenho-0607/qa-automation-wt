    ...
    def test_TC01(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, trade_type="trade", option="buy", set_Chart=True, chart_fullscreen="chart-toggle-fullscreen", set_fillPolicy=True, sl_type="points", tp_type="price")
