    ...
    def test_TC02(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Market Order"):
                trade_market_order(driver=main_driver, trade_type="trade", option="buy", set_Chart=True, chart_fullscreen="chart-toggle-fullscreen", set_fillPolicy=True, sl_type="price", tp_type="points")
            ...
            with allure.step("Retrieve and compare Open Position and Notification Order Message / Details"):
                ...
                compare_dataframes(df1=open_position_df, name1="Open Position",
                                   ...
                                   required_columns=["Symbol", "Order No.", "Volume"])
