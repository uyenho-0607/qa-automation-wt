    ...
    def test_TC07(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stopLimit_order(driver=main_driver, trade_type="trade", option="buy", set_stopLoss=False, set_takeProfit=False, expiryType="good-till-day", set_Chart=True, chart_fullscreen="chart-toggle-fullscreen")
