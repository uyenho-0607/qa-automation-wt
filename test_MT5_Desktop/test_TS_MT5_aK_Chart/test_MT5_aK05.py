    ...
    def test_tc05(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Order"):
                trade_stop_order(driver=main_driver, trade_type="trade", option="buy", sl_type="price", tp_type="points", expiryType="specified-date-and-time", expiryDate="19", targetMonth=parse("Feb 2025"), hour_option="11", min_option="35", specifiedDate=True, set_Chart=True, chart_fullscreen="toggle")
