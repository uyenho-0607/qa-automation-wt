    ...
    def test_TC15(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="buy", set_stopLoss=False, tp_type="price", takeProfit_flag=False, expiryType="good-till-day")
