...
from common.desktop.module_trade.utils import toggle_radioButton_OCT, trade_stopLimit_order, get_neg_snackbar_banner
...
class TC_MT5_aR33():
    ...
    def test_TC33(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                # neg_trade_stopLimit_order(driver=main_driver, trade_type="trade", option="sell", set_stopLoss=False, entryPrice_flag=False, stopLimitPrice_flag=False)
