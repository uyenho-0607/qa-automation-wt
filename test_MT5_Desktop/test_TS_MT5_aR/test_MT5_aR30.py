...
class TC_MT5_aR30():
    ...
    def test_TC30(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                # neg_trade_stopLimit_order(driver=main_driver, trade_type="trade", option="buy", set_takeProfit=False, entryPrice_flag=False, stopLimitPrice_flag=False)
