...
class TC_MT5_aR36():
    ...
    def test_TC36(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Modify on Stop Limit Order"):
                # neg_modify_stopLimit_order(driver=main_driver, trade_type="edit", row_number=[1], set_takeProfit=False, entryPrice_flag=False, stopLimitPrice_flag=False)
