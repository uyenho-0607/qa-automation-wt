...
from common.desktop.module_trade.utils import toggle_radioButton_OCT, trade_limit_order, modify_limit_order, get_neg_snackbar_banner, get_trade_snackbar_banner, extract_order_info
    ...
    def test_TC17(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Modify on Limit Order"):
                modify_limit_order(driver=main_driver, trade_type="edit", row_number=[1], stopLoss_flag=False, sl_type="price", set_takeProfit=False, expiryType="good-till-cancelled")
