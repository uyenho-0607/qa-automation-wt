    ...
    def test_TC15(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stopLimit_order(driver=main_driver, trade_type="trade", option="sell", sl_type="price", tp_type="points", expiryType="specified-date", expiryDate="19", targetMonth=datetime.strptime("Feb 2025", "%b %Y"), specifiedDate=True)
