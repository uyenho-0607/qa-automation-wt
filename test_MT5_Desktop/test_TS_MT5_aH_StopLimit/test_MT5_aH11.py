    ...
    def test_TC11(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stopLimit_order(driver=main_driver, trade_type="trade", option="sell", sl_type="points", set_takeProfit=False, expiryType="specified-date", expiryDate="19", targetMonth=parse("Feb 2025"), specifiedDate=True)
            ...
            with allure.step("Modify Stop Limit Order"):
                modify_stopLimit_order(driver=main_driver, trade_type="edit", row_number=[1], sl_type="points", set_takeProfit=False, expiryType="specified-date", expiryDate="19", targetMonth=parse("Feb 2025"), specifiedDate=True)
