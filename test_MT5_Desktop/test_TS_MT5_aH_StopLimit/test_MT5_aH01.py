    ...
    def test_TC01(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stopLimit_order(driver=main_driver, trade_type="trade", option="buy", set_stopLoss=False, set_takeProfit=False, expiryType="good-till-cancelled")
            ...
            with allure.step("Modify Stop Limit Order"):
                modify_stopLimit_order(driver=main_driver, trade_type="edit", row_number=[1], sl_type="points", set_takeProfit=False, expiryType="good-till-cancelled")
            ...
            with allure.step("Retrieve the Updated Order Panel data"):
                ...
                clear_orderIDs_csv(filename="MT5_Desktop_StopLimit.csv")
