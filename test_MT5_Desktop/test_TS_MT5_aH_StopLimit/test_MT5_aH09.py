    ...
    def test_TC09(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Modify Stop Limit Order"):
                modify_stopLimit_order(driver=main_driver, trade_type="edit", row_number=[1], sl_type="price", set_takeProfit=False, expiryType="good-till-day")
