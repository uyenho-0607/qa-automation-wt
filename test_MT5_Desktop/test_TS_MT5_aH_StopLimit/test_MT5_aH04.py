    ...
    def test_TC04(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Stop Limit Order"):
                trade_stopLimit_order(driver=main_driver, trade_type="trade", option="buy", sl_type="price", set_takeProfit=False, expiryType="specified-date-and-time", expiryDate="19", targetMonth=datetime.strptime("Nov 2024", "%b %Y"), hour_option="11", min_option="35", specifiedDate=True)
            ...
            with allure.step("Modify Stop Limit Order"):
                modify_stopLimit_order(driver=main_driver, trade_type="edit", row_number=[1], sl_type="price", set_takeProfit=False, expiryType="specified-date", expiryDate="19", targetMonth=datetime.strptime("Nov 2024", "%b %Y"), specifiedDate=True)
