    ...
    def test_tc12(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="sell", sl_type="price", set_takeProfit=False, expiryType="specified-date-and-time", expiryDate="19", targetMonth=parse("Feb 2025"), hour_option="11", min_option="35", specifiedDate=True)
