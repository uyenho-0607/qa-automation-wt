    ...
    def test_TC15(self, chromeDriver):
        ...
        try:
            ...
            with allure.step("Place Limit Order"):
                trade_limit_order(driver=main_driver, trade_type="trade", option="sell", sl_type="price", tp_type="points", expiryType="specified-date", expiryDate="19", targetMonth=datetime.strptime("Nov 2024", "%b %Y"), specifiedDate=True)
